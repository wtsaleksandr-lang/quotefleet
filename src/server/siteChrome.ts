...
export const SITE_NAV_HTML = `<nav class="site-nav" aria-label="Main navigation">`
  ...
  + `<div class="nav-dd-group"><p class="nav-dd-head">Get freight quotes</p><a href="/directory/rfq">Get Freight Quotes (RFQ)</a><a href="/directory/join">Directory Pro</a></div>`
  + `</div></div>`
  + `<div class="nav-dd" data-nav-dd>`
