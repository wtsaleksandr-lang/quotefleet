...
export type OAuthProviderId = 'google' | 'microsoft' | 'meta';

export const OAUTH_PROVIDER_IDS: OAuthProviderId[] = ['google', 'microsoft', 'meta'];
...
const USERINFO_URLS: Record<OAuthProviderId, string> = {
